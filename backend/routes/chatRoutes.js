...
module.exports = (io) => {
    const { getMessages, sendMessage, deleteMessage, editMessage, deleteConversation } = require('../controllers/chatController')(io);
    ...
    router.delete('/delete-conversation', authenticate, deleteConversation); // 👈 Added route
