...
const ProfileInfo = ({ user }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4 p-6 bg-white border border-gray-100 shadow-sm dark:bg-gray-800 rounded-xl dark:border-gray-700">
        <div className="flex items-center justify-center w-16 h-16 overflow-hidden text-2xl font-bold text-indigo-600 bg-indigo-100 border-2 border-indigo-500 rounded-full dark:bg-indigo-900/50 dark:text-indigo-400">
          {user?.profilePicture ? (
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        {/* Favorite Places */}
        <InfoCard title="Favorite Places" className="md:col-span-2">
